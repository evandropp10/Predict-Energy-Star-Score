...
# Regressão Linear
x = ["Year Built", "Number of Buildings - Self-reported", "Occupancy", "Site EUI (kBtu/ft²)", "Largest Property Use Type - Gross Floor Area (ft²)"]
y = "ENERGY STAR Score"
...
print('MAE Model 32:', metrics.mean_absolute_error(dfPrModel03['Test'],dfPrModel03['Prediction']))
...
print('MAE Model 18:', metrics.mean_absolute_error(dfPrModel04['Test'],dfPrModel04['Prediction']))